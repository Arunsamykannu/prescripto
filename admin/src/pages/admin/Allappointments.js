      ...
      <div className='bg-white rounded border text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        </div>
        {
              appointments.map((val,index)=>{
                return(<div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-300' key={index}>
                  ...
                  <div className='flex items-center gap-2 '>
                    <img className='w-8 rounded-full' src={val.docData.image} alt=''/>
                    <p>{val.docData.name}</p>
